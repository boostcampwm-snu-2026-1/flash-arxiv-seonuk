export const ARXIV_TAXONOMY = [
  ...
  {
    id: 'nlin', name: 'Nonlinear Sciences',
    subs: [
  ...
  { id: 'quant-ph', name: 'Quantum Physics', subs: [] },
  { id: 'gr-qc',   name: 'General Relativity and Quantum Cosmology', subs: [] },
  { id: 'hep-th',  name: 'High Energy Physics — Theory', subs: [] },
  { id: 'hep-ph',  name: 'High Energy Physics — Phenomenology', subs: [] },
  { id: 'hep-ex',  name: 'High Energy Physics — Experiment', subs: [] },
  { id: 'hep-lat', name: 'High Energy Physics — Lattice', subs: [] },
  { id: 'nucl-th', name: 'Nuclear Theory', subs: [] },
  { id: 'nucl-ex', name: 'Nuclear Experiment', subs: [] },
]
